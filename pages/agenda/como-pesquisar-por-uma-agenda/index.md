...
<div class="text-center"> 
  <img alt="Pesquisar por uma agenda" src="como-pesquisar-por-uma-agenda-img-01.png" style="width: 90%; margin-bottom: 20px;">
</div>

Para pesquisar uma determinada agenda, digite na **caixa de pesquisa** o nome da agenda.

<div class="text-center"> 
  <img alt="Pesquisar por uma agenda" src="como-pesquisar-por-uma-agenda-img-02.png" style="width: 90%; margin-bottom: 20px;">
</div>

A pesquisa é feita dinamicamente, de forma, que ao digitar cada letra/caractere é retornado uma ou mais agendas.

<div class="text-center"> 
  <img alt="Pesquisar por uma agenda" src="como-pesquisar-por-uma-agenda-img-03.png" style="width: 90%; margin-bottom: 20px;">
</div>
...
<div class="text-center"> 
  <img alt="Pesquisar por uma agenda" src="como-pesquisar-por-uma-agenda-img-04.png" style="width: 90%; margin-bottom: 20px;">
</div>
