...
<div class="text-center"> 
  <img alt="Tipos de agendamento" src="/pages/agenda/filtrar-agendamentos-pela-situacao/menu_status.png" style="width: 90%; margin-bottom: 20px;">
</div>
...
<div class="text-center"> 
  <img alt="Tipos de agendamento" src="/pages/agenda/filtrar-agendamentos-pela-situacao/cor_status_agendamento.png" style="width: 90%; margin-bottom: 20px;">
</div>

Se quiser retirar um filtro basta clicar no item, e caso queira adicionar novamente é só clicar nele novamente.

<div class="text-center"> 
  <img alt="Tipos de agendamento" src="/pages/agenda/filtrar-agendamentos-pela-situacao/agendamento_filtrado.png" style="width: 90%; margin-bottom: 20px;">
</div>
