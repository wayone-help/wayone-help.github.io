...
<div class="text-center"> 
  <img alt="pesquisar-anamnese-img-1" src="pesquisar-anamnese-img-1.png" style="width: 90%; margin-bottom: 20px;">
</div>
...
<div class="text-center"> 
  <img alt="pesquisar-anamnese-img-2" src="pesquisar-anamnese-img-2.png" style="width: 90%; margin-bottom: 20px;">
</div>

Será mostrado o resultado filtrado, caso queira limpar o filtro, clique no **X** que está na parte superior direita da lista.

<div class="text-center"> 
  <img alt="pesquisar-anamnese-img-3" src="pesquisar-anamnese-img-3.png" style="width: 90%; margin-bottom: 20px;">
</div>
