...
<div class="text-center"> 
  <img alt="lista de clínicas" src="/pages/clinica/como-configurar-envio-email-apos-agendamento/enviar_email.png" style="width: 90%;">
</div>

Após concluir, clique no botão **salvar**, no final da página de edição da clínica

<div class="text-center"> 
  <img alt="Tipos de agendamento" src="/pages/clinica/como-configurar-envio-email-apos-agendamento/salvar_edicao_clinica.png" style="width: 90%;">
</div>