...
<div class="text-center"> 
  <img alt="lista de clínicas" src="/pages/clinica/como-configurar-tempo-minimo-consulta/tempo_minimo_consulta.png" style="width: 90%; margin-bottom: 20px;">
</div>

Após concluir, clique no botão **salvar**, no final da página de edição da clínica

<div class="text-center"> 
  <img alt="Tipos de agendamento" src="/pages/clinica/como-configurar-tempo-minimo-consulta/salvar_edicao_clinica.png" style="width: 90%; margin-bottom: 20px;">
</div>