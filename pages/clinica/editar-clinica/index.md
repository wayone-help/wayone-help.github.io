...
<div class="text-center"> 
  <img alt="lista de clínicas" src="/pages/clinica/editar-clinica/lista_clinicas.png" style="width: 90%; margin-bottom: 20px;">
</div>

<div class="text-center"> 
  <img alt="Tipos de agendamento" src="/pages/clinica/editar-clinica/lista_clinicas_menu.png" style="width: 90%; margin-bottom: 20px;">
</div>

Será aberto a tela de edição da clínica, edite conforme a necessidade e clique no final da página, no botão **salvar**

<div class="text-center"> 
  <img alt="Tipos de agendamento" src="/pages/clinica/editar-clinica/salvar_edicao_clinica.png" style="width: 90%; margin-bottom: 20px;">
</div>