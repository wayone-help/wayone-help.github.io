...
<div class="text-center"> 
  <img alt="filttro" src="filtro-agendas-img-01.png" style="width: 90%; margin-bottom: 20px;">
</div>

Pesquisa através de uma agenda específica.
<div class="text-center"> 
  <img alt="filttro" src="filtro-agendas-img-02.png" style="width: 90%; margin-bottom: 20px;">
</div>

Filtro referente a um período a ser pesquisado.
<div class="text-center"> 
  <img alt="filttro" src="filtro-agendas-img-03.png" style="width: 90%; margin-bottom: 20px;">
</div>

Opções possíveis para filtro de período
<div class="text-center"> 
  <img alt="filttro" src="filtro-agendas-img-04.png" style="width: 90%; margin-bottom: 20px;">
</div>