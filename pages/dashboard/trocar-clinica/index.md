...
<div class="text-center"> 
  <img alt="Trocar Clinica" src="/pages/dashboard/trocar-clinica/trocar-clinica-img-1.png" style="width: 90%; margin-bottom: 20px;">
</div>
...
<div class="text-center"> 
  <img alt="Seleção de Clínica" src="/pages/dashboard/trocar-clinica/trocar-clinica-img-2.png" style="width: 90%; margin-bottom: 20px;">
</div>

A mudança pode ser observada no nome da clínica localizado no canto **superior direito**.

<div class="text-center"> 
  <img alt="Dashboard Filial" src="/pages/dashboard/trocar-clinica/trocar-clinica-img-3.png" style="width: 90%; margin-bottom: 20px;">
</div>