...
<div class="text-center"> 
  <img alt="Tipos de agendamento" src="/pages/gestao-anamnese/como-enviar-uma-anamnese-para-paciente-responder/lista_anamnese_filtrada.png" style="width: 90%; margin-bottom: 20px;">
</div>

<div class="text-center"> 
  <img alt="Tipos de agendamento" src="/pages/gestao-anamnese/como-enviar-uma-anamnese-para-paciente-responder/lista_anamnese_menu.png" style="width: 90%; margin-bottom: 20px;">
</div>
...
<div class="text-center"> 
  <img alt="Tipos de agendamento" src="/pages/gestao-anamnese/como-enviar-uma-anamnese-para-paciente-responder/lista_anamnese_confirmacao.png" style="width: 90%; margin-bottom: 20px;">
</div>
