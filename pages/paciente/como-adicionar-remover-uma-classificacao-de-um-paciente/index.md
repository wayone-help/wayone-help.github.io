...
<div class="text-center"> 
  <img alt="Adicionando classificação do paciente" src="como-adicionar-remover-uma-classificacao-de-um-paciente-img-01.png" style="width: 90%; margin-bottom: 20px;">
</div>
...
<div class="text-center"> 
  <img alt="Adicionando classificação do paciente" src="como-adicionar-remover-uma-classificacao-de-um-paciente-img-02.png" style="width: 90%; margin-bottom: 20px;">
</div>
...
<div class="text-center"> 
  <img alt="Removendo classificação do paciente" src="como-adicionar-remover-uma-classificacao-de-um-paciente-img-03.png" style="width: 90%; margin-bottom: 20px;">
</div>