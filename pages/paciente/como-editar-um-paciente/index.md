...
<div class="text-center"> 
  <img alt="Removendo paciente" src="como-editar-um-paciente-img-01.png" style="width: 90%; margin-bottom: 20px;">
</div>

<div class="text-center"> 
  <img alt="Removendo paciente" src="como-editar-um-paciente-img-02.png" style="width: 90%; margin-bottom: 20px;">
</div>

Formulário de edição dos dados do paciente.

<div class="text-center"> 
  <img alt="Removendo paciente" src="como-editar-um-paciente-img-03.png" style="width: 90%; margin-bottom: 20px;">
</div>

Será aberto a tela de edição do perfil, edite conforme a necessidade e clique no final da página, no botão **salvar**

<div class="text-center"> 
  <img alt="Removendo paciente" src="como-editar-um-paciente-img-04.png" style="width: 90%; margin-bottom: 20px;">
</div>