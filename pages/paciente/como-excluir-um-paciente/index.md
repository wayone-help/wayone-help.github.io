...
<div class="text-center"> 
  <img alt="Removendo paciente" src="como-excluir-um-paciente-img-01.png" style="width: 90%; margin-bottom: 20px;">
</div>

<div class="text-center"> 
  <img alt="Removendo paciente" src="como-excluir-um-paciente-img-02.png" style="width: 90%; margin-bottom: 20px;">
</div>

É obrigatório informar uma justificativa para poder confirmar a remoção do cadastro.

<div class="text-center"> 
  <img alt="Removendo paciente" src="como-excluir-um-paciente-img-03.png" style="width: 90%; margin-bottom: 20px;">
</div>