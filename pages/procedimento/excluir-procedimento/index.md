...
<div class="text-center"> 
  <img alt="excluir-procedimento-img-1" src="excluir-procedimento-img-1.png" style="width: 90%; margin-bottom: 20px;">
</div>

Sera solicitada a confirmação da exclusão.

<div class="text-center"> 
  <img alt="excluir-procedimento-img-2" src="excluir-procedimento-img-2.png" style="width: 90%; margin-bottom: 20px;">
</div>
