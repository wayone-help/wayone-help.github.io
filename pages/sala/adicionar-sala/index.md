...
<div class="text-center"> 
  <img alt="adicionar-sala-img-1" src="adicionar-sala-img-1.png" style="width: 90%; margin-bottom: 20px;">
</div>

Sera apresentada a tela de cadastro de uma nova sala.

<div class="text-center"> 
  <img alt="adicionar-sala-img-2" src="adicionar-sala-img-2.png" style="width: 90%; margin-bottom: 20px;">
</div>
