...
<div class="text-center">
  <img alt="lista de clínicas" src="/pages/tabelas-de-preco/como-duplicar-uma-tabela-de-preco/lista_duplicar.png" style="width: 90%;">
</div>

Aparecerá uma popup para confirmar, clique em **sim**

<div class="text-center">
  <img alt="lista de clínicas" src="/pages/tabelas-de-preco/como-duplicar-uma-tabela-de-preco/lista_confirmar_duplicar.png" style="width: 90%;">
</div>

A tabela duplicada aparecerá na lista pelo nome: **Cópia de** + **nome da tabela copiada**

<div class="text-center">
  <img alt="Tipos de agendamento" src="/pages/tabelas-de-preco/como-duplicar-uma-tabela-de-preco/tabela_copia.png" style="width: 90%;">
</div>